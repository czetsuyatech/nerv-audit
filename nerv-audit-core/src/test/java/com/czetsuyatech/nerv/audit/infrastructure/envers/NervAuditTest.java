...
class NervAuditTest {
  ...
  @Autowired
  private NervEnversListenerConfigurer listenerConfigurer;

  @Test
  void contextStartsWithoutLicenseConfiguration() {
    assertThat(listenerConfigurer).isNotNull();
  }
